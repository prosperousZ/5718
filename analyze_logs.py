...
for exp in experiments:
    # TCP
    tcp_log = f"{exp}_tcp_h2_h1.log"
    ping_tcp_log = f"{exp}_ping_during_tcp_h2_h1.log"
    ...
    # UDP
    udp_log = f"{exp}_udp_h2_h1.log"
    ping_udp_log = f"{exp}_ping_during_udp_h2_h1.log"
    ...
    # ICMP（只看 ping-only）
    ping_icmp_log = f"{exp}_ping_h2_h1.log"
